...
// node_modules/swiper/node_modules/dom7/node_modules/ssr-window/dist/ssr-window.esm.js
...
// node_modules/swiper/node_modules/dom7/dist/dom7.modular.js
var Dom7 = class {
  constructor(arr) {
    const self = this;
...
var doc2 = typeof document === "undefined" ? {
  body: {},
...
var win2 = typeof window === "undefined" ? {
  document: doc2,
  navigator: {
    userAgent: ""
  },
...
var Utils = {
  ...
  getTranslate(el, axis = "x") {
    ...
    let curTransform;
    let transformMatrix;
    const curStyle = win2.getComputedStyle(el, null);
    if (win2.WebKitCSSMatrix) {
      curTransform = curStyle.transform || curStyle.webkitTransform;
      if (curTransform.split(",").length > 6) {
        curTransform = curTransform.split(", ").map((a) => a.replace(",", ".")).join(", ");
      }
      transformMatrix = new win2.WebKitCSSMatrix(curTransform === "none" ? "" : curTransform);
    } else {
  ...
  parseUrlQuery(url) {
    const query = {};
    let urlToParse = url || win2.location.href;
    let i;
    let params;
    let param;
    let length;
...
var Support = function Support2() {
  const testDiv = doc2.createElement("div");
  return {
    touch: win2.Modernizr && win2.Modernizr.touch === true || function checkTouch() {
      return !!(win2.navigator.maxTouchPoints > 0 || "ontouchstart" in win2 || win2.DocumentTouch && doc2 instanceof win2.DocumentTouch);
    }(),
    pointerEvents: !!(win2.navigator.pointerEnabled || win2.PointerEvent || "maxTouchPoints" in win2.navigator && win2.navigator.maxTouchPoints > 0),
    prefixedPointerEvents: !!win2.navigator.msPointerEnabled,
    transition: function checkTransition() {
      const style = testDiv.style;
      return "transition" in style || "webkitTransition" in style || "MozTransition" in style;
    }(),
    transforms3d: win2.Modernizr && win2.Modernizr.csstransforms3d === true || function checkTransforms3d() {
      const style = testDiv.style;
      return "webkitPerspective" in style || "MozPerspective" in style || "OPerspective" in style || "MsPerspective" in style || "perspective" in style;
    }(),
    flexbox: function checkFlexbox() {
      const style = testDiv.style;
      const styles2 = "alignItems webkitAlignItems webkitBoxAlign msFlexAlign mozBoxAlign webkitFlexDirection msFlexDirection mozBoxDirection mozBoxOrient webkitBoxDirection webkitBoxOrient".split(" ");
      for (let i = 0; i < styles2.length; i += 1) {
        if (styles2[i] in style)
          return true;
      }
      return false;
    }(),
    observer: function checkObserver() {
      return "MutationObserver" in win2 || "WebkitMutationObserver" in win2;
    }(),
    passiveListener: function checkPassiveListener() {
      ...
      try {
        ...
        win2.addEventListener("testPassiveListener", null, opts);
      } catch (e) {
      }
      return supportsPassive;
    }(),
    gestures: function checkGestures() {
      return "ongesturestart" in win2;
    }()
  };
}();
var Browser = function Browser2() {
  function isSafari() {
    const ua = win2.navigator.userAgent.toLowerCase();
    return ua.indexOf("safari") >= 0 && ua.indexOf("chrome") < 0 && ua.indexOf("android") < 0;
  }
  return {
    isIE: !!win2.navigator.userAgent.match(/Trident/g) || !!win2.navigator.userAgent.match(/MSIE/g),
    isEdge: !!win2.navigator.userAgent.match(/Edge/g),
    isSafari: isSafari(),
    isUiWebView: /(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(win2.navigator.userAgent)
  };
}();
...
function updateSlides() {
  ...
  for (let i = 0; i < slidesLength; i += 1) {
    ...
    if (params.slidesPerColumn > 1) {
      ...
      slide2.css(`margin-${swiper.isHorizontal() ? "top" : "left"}`, row !== 0 && params.spaceBetween && `${params.spaceBetween}px`).attr("data-swiper-column", column).attr("data-swiper-row", row);
    }
    if (slide2.css("display") === "none")
      continue;
    if (params.slidesPerView === "auto") {
      const slideStyles = win2.getComputedStyle(slide2[0], null);
...
function slideToClosest(speed = this.params.speed, runCallbacks = true, internal) {
  ...
  const snapIndex = Math.floor(index2 / swiper.params.slidesPerGroup);
  ...
  if (params.loopFillGroupWithBlank) {
    ...
    if (blankSlidesNum !== params.slidesPerGroup) {
      for (let i = 0; i < blankSlidesNum; i += 1) {
        const blankNode = $(doc2.createElement("div")).addClass(`${params.slideClass} ${params.slideBlankClass}`);
...
var Device = function Device2() {
  const ua = win2.navigator.userAgent;
  const device = {
    ios: false,
    android: false,
    androidChrome: false,
    ...
    ipod: false,
    ipad: false,
    cordova: win2.cordova || win2.phonegap,
    phonegap: win2.cordova || win2.phonegap
  };
  ...
  if (device.os && device.os === "ios") {
    ...
    const metaViewport = doc2.querySelector('meta[name="viewport"]');
    device.minimalUi = !device.webView && (ipod || iphone) && (osVersionArr[0] * 1 === 7 ? osVersionArr[1] * 1 >= 1 : osVersionArr[0] * 1 > 7) && metaViewport && metaViewport.getAttribute("content").indexOf("minimal-ui") >= 0;
  }
  device.pixelRatio = win2.devicePixelRatio || 1;
  return device;
}();
function onTouchStart(event) {
  ...
  if (edgeSwipeDetection && (startX <= edgeSwipeThreshold || startX >= win2.screen.width - edgeSwipeThreshold)) {
    return;
  }
  Utils.extend(data2, {
    isTouched: true,
  ...
  if (e.type !== "touchstart") {
    ...
    if ($(e.target).is(data2.formElements))
      preventDefault = false;
    if (doc2.activeElement && $(doc2.activeElement).is(data2.formElements) && doc2.activeElement !== e.target) {
...
function onTouchMove(event) {
  ...
  if (data2.isTouchEvent && e.type === "mousemove")
    return;
  ...
  if (data2.isTouchEvent && doc2.activeElement) {
    if (e.target === doc2.activeElement && $(e.target).is(data2.formElements)) {
      data2.isMoved = true;
      swiper.allowClick = false;
      return;
    }
...
function onTouchEnd(event) {
  ...
  if (swiper.allowClick) {
    ...
    if (timeDiff < 300 && touchEndTime - data2.lastClickTime > 300) {
      if (data2.clickTimeout)
        clearTimeout(data2.clickTimeout);
      data2.clickTimeout = Utils.nextTick(() => {
        if (!swiper || swiper.destroyed)
          return;
        swiper.emit("click", e);
      }, 300);
...
function attachEvents() {
  ...
  const capture = !!params.nested;
  {
    if (!Support.touch && (Support.pointerEvents || Support.prefixedPointerEvents)) {
      ...
      doc2.addEventListener(touchEvents.move, swiper.onTouchMove, capture);
      doc2.addEventListener(touchEvents.end, swiper.onTouchEnd, false);
    } else {
      if (Support.touch) {
      ...
      if (params.simulateTouch && !Device.ios && !Device.android || params.simulateTouch && !Support.touch && Device.ios) {
        ...
        doc2.addEventListener("mousemove", swiper.onTouchMove, capture);
        doc2.addEventListener("mouseup", swiper.onTouchEnd, false);
      }
    }
...
function detachEvents() {
  ...
  const capture = !!params.nested;
  {
    if (!Support.touch && (Support.pointerEvents || Support.prefixedPointerEvents)) {
      ...
      doc2.removeEventListener(touchEvents.move, swiper.onTouchMove, capture);
      doc2.removeEventListener(touchEvents.end, swiper.onTouchEnd, false);
    } else {
      if (Support.touch) {
      ...
      if (params.simulateTouch && !Device.ios && !Device.android || params.simulateTouch && !Support.touch && Device.ios) {
        ...
        doc2.removeEventListener("mousemove", swiper.onTouchMove, capture);
        doc2.removeEventListener("mouseup", swiper.onTouchEnd, false);
      }
    }
    if (params.preventClicks || params.preventClicksPropagation) {
...
function getBreakpoint(breakpoints2) {
  ...
  for (let i = 0; i < points.length; i += 1) {
    ...
    if (swiper.params.breakpointsInverse) {
      if (point <= win2.innerWidth) {
        breakpoint = point;
      }
    } else if (point >= win2.innerWidth && !breakpoint) {
      breakpoint = point;
    }
  }
...
var Resize = {
  ...
  on: {
    init() {
      const swiper = this;
      win2.addEventListener("resize", swiper.resize.resizeHandler);
      win2.addEventListener("orientationchange", swiper.resize.orientationChangeHandler);
    },
    destroy() {
      const swiper = this;
      win2.removeEventListener("resize", swiper.resize.resizeHandler);
      win2.removeEventListener("orientationchange", swiper.resize.orientationChangeHandler);
    }
  }
};
var Observer = {
  func: win2.MutationObserver || win2.WebkitMutationObserver,
  attach(target, options = {}) {
    ...
    const observer = new ObserverFunc((mutations) => {
      ...
      if (win2.requestAnimationFrame) {
        win2.requestAnimationFrame(observerUpdate);
      } else {
        win2.setTimeout(observerUpdate, 0);
      }
    });
...
var Keyboard = {
  handle(event) {
    ...
    if (doc2.activeElement && doc2.activeElement.nodeName && (doc2.activeElement.nodeName.toLowerCase() === "input" || doc2.activeElement.nodeName.toLowerCase() === "textarea")) {
      return void 0;
    }
    if (swiper.params.keyboard.onlyInViewport && (kc === 33 || kc === 34 || kc === 37 || kc === 39 || kc === 38 || kc === 40)) {
      ...
      const windowWidth = win2.innerWidth;
      const windowHeight = win2.innerHeight;
  ...
  enable() {
    ...
    if (swiper.keyboard.enabled)
      return;
    $(doc2).on("keydown", swiper.keyboard.handle);
  ...
  disable() {
    ...
    if (!swiper.keyboard.enabled)
      return;
    $(doc2).off("keydown", swiper.keyboard.handle);
...
function isEventSupported() {
  ...
  let isSupported = eventName in doc2;
  if (!isSupported) {
    const element = doc2.createElement("div");
    element.setAttribute(eventName, "return;");
    isSupported = typeof element[eventName] === "function";
  }
  if (!isSupported && doc2.implementation && doc2.implementation.hasFeature && doc2.implementation.hasFeature("", "") !== true) {
    isSupported = doc2.implementation.hasFeature("Events.wheel", "3.0");
  }
  return isSupported;
}
var Mousewheel = {
  ...
  event: function getEvent() {
    if (win2.navigator.userAgent.indexOf("firefox") > -1)
  ...
  handle(event) {
    ...
    if (!swiper.params.freeMode) {
      ...
      swiper.mousewheel.lastScrollTime = new win2.Date().getTime();
    } else {
      if (swiper.params.loop) {
        swiper.loopFix();
      }
...
var Scrollbar = {
  ...
  enableDraggable() {
    ...
    if (!Support.touch) {
      ...
      doc2.addEventListener(touchEventsDesktop.move, swiper.scrollbar.onDragMove, activeListener);
      doc2.addEventListener(touchEventsDesktop.end, swiper.scrollbar.onDragEnd, passiveListener);
    } else {
  ...
  disableDraggable() {
    ...
    if (!Support.touch) {
      ...
      doc2.removeEventListener(touchEventsDesktop.move, swiper.scrollbar.onDragMove, activeListener);
      doc2.removeEventListener(touchEventsDesktop.end, swiper.scrollbar.onDragEnd, passiveListener);
    } else {
...
var History = {
  init() {
    ...
    if (!swiper.params.history)
      return;
    if (!win2.history || !win2.history.pushState) {
    ...
    if (!swiper.params.history.replaceState) {
      win2.addEventListener("popstate", swiper.history.setHistoryPopState);
    }
  },
  destroy() {
    const swiper = this;
    if (!swiper.params.history.replaceState) {
      win2.removeEventListener("popstate", swiper.history.setHistoryPopState);
    }
  },
  setHistoryPopState() {
    const swiper = this;
  ...
  getPathValues() {
    const pathArray = win2.location.pathname.slice(1).split("/").filter((part) => part !== "");
  ...
  setHistory(key, index2) {
    ...
    if (!win2.location.pathname.includes(key)) {
      value = `${key}/${value}`;
    }
    const currentState = win2.history.state;
    if (currentState && currentState.value === value) {
      return;
    }
    if (swiper.params.history.replaceState) {
      win2.history.replaceState({ value }, null, value);
    } else {
      win2.history.pushState({ value }, null, value);
    }
  },
  slugify(text2) {
...
var HashNavigation = {
  onHashCange() {
    const swiper = this;
    const newHash = doc2.location.hash.replace("#", "");
  ...
  setHash() {
    ...
    if (!swiper.hashNavigation.initialized || !swiper.params.hashNavigation.enabled)
      return;
    if (swiper.params.hashNavigation.replaceState && win2.history && win2.history.replaceState) {
      win2.history.replaceState(null, null, `#${swiper.slides.eq(swiper.activeIndex).attr("data-hash")}` || "");
    } else {
      const slide2 = swiper.slides.eq(swiper.activeIndex);
      const hash = slide2.attr("data-hash") || slide2.attr("data-history");
      doc2.location.hash = hash || "";
    }
  },
  init() {
    const swiper = this;
    ...
    const hash = doc2.location.hash.replace("#", "");
    if (hash) {
      const speed = 0;
      for (let i = 0, length = swiper.slides.length; i < length; i += 1) {
        const slide2 = swiper.slides.eq(i);
    ...
    if (swiper.params.hashNavigation.watchState) {
      $(win2).on("hashchange", swiper.hashNavigation.onHashCange);
    }
  },
  destroy() {
    const swiper = this;
    if (swiper.params.hashNavigation.watchState) {
      $(win2).off("hashchange", swiper.hashNavigation.onHashCange);
    }
  }
};
