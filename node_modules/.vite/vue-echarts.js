...
function b(e) {
  return t = Object.create(null), m.forEach(function(n) {
    t[n] = function(t2) {
      return function() {
        for (var n2 = [], o = 0; o < arguments.length; o++)
          n2[o] = arguments[o];
        if (!e.value)
...
!function(e, t) {
  if (e && typeof document != "undefined") {
    ...
    if (r) {
      var a = E.indexOf(i);
      a === -1 && (a = E.push(i) - 1, z[a] = {}), n = z[a] && z[a][o] ? z[a][o] : z[a][o] = u();
    } else
      n = u();
...
var U = defineComponent({ name: "echarts", props: O(O({ option: Object, theme: { type: [Object, String] }, initOptions: Object, updateOptions: Object, group: String, manualUpdate: Boolean }, y), j), inheritAttrs: false, setup: function(i, l) {
  var p = l.attrs, m2 = l.listeners, y2 = shallowRef(), x2 = shallowRef(), j2 = shallowRef(), E2 = inject("ecTheme", null), z2 = inject("ecInitOptions", null), A2 = inject("ecUpdateOptions", null), w2 = toRefs(i), C2 = w2.autoresize, T2 = w2.manualUpdate, U2 = w2.loading, D = w2.loadingOptions, S = computed(function() {
    return j2.value || i.option || null;
  }), k = computed(function() {
    return i.theme || unref(E2) || {};
  }), B = computed(function() {
    return i.initOptions || unref(z2) || {};
  }), P = computed(function() {
    return i.updateOptions || unref(A2) || {};
  }), I = computed(function() {
    return function(e) {
      var t = {};
      for (var n in e)
  ...
  watch(T2, function(t) {
    typeof q == "function" && (q(), q = null), t || (q = watch(function() {
      ...
      e && (x2.value ? x2.value.setOption(e, O({ notMerge: e.value !== (t2 == null ? void 0 : t2.value) }, P.value)) : N());
    }, { deep: true }));
