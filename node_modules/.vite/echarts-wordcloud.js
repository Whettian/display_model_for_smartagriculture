...
extendChartView({
  ...
  render: function(seriesModel, ecModel, api) {
    ...
    seriesModel.layoutInstance.ondraw = function(text, size, dataIdx, drawn) {
      ...
      textEl.ensureState("emphasis").style = helper_exports.createTextStyle(itemModel.getModel(["emphasis", "textStyle"]), {
        state: "emphasis"
      });
      textEl.ensureState("blur").style = helper_exports.createTextStyle(itemModel.getModel(["blur", "textStyle"]), {
        state: "blur"
      });
      helper_exports.enableHoverEmphasis(textEl, itemModel.get(["emphasis", "focus"]), itemModel.get(["emphasis", "blurScope"]));
